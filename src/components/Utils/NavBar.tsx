    ...
    <div className=" bg-secondary ">
      <div className=" flex items-center relative justify-between h-[40px] md:h-[70px] px-4 sm:px-8 md:px-16 lg:px-32 xl:px-64 max-w-7xl w-full mx-auto">
       <Link href="/"><h2 className="font-serif  font-bold md:text-[24px] text-[16px]">
          IGot
          <span className="text-primary "><i>Standards</i></span>Bro
        </h2></Link>
        <FiMenu
        ...
        />
        {open && (
          <ul className=" justify-center items-center gap-10 flex flex-col md:hidden z-20 font-semibold fixed top-0 bg-primary bg-opacity-70 w-[100%] left-0  text-white h-screen" onClick={handleOpen} >
            <Link href="/">
              {" "}

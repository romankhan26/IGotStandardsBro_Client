...
const Privacy= ()=>{        
    return (
      <div className="px-4 sm:px-8 md:px-16 lg:px-44 xl:px-72 max-w-7xl w-full mx-auto my-10 md:my-20">
        ...
        <div className="bg-secondary shadow-xl text-base	md:text-lg rounded-xl  space-y-4 p-4 md:p-8 pb-8 md:pb-16">
          <p>
...
<h3  className="font-semibold text-2xl md:text-3xl  my-2 ">Information we collect</h3>
<p>
...
<h3  className="font-semibold text-2xl md:text-3xl  my-2 ">Analytics</h3>
<p>We use Google Analytics to track our website statistics.</p>
<h3  className="font-semibold text-2xl md:text-3xl  my-2 ">Log Files</h3>
...
<h3  className="font-semibold text-2xl md:text-3xl  my-2 ">Google DoubleClick DART Cookie</h3>
...
<h3  className="font-semibold text-2xl md:text-3xl  my-2 ">Third-Party Privacy Policies</h3>
<p>
...
<h3  className="font-semibold text-2xl md:text-3xl  my-2 ">Children&apos;s Information</h3>
<p>Another part of our priority is adding protection for children while using the internet. We encourage parents and guardians to observe, participate in, and/or monitor and guide their online activity.</p>
<h3  className="font-semibold text-2xl md:text-3xl  my-2 ">Ezoic Privacy Policy</h3>

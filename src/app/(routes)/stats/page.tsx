import { H_One, H_Two } from "@/components/Utils/Typography";
...
"
      ...
      <div className="bg-secondary shadow-xl space-y-4 text-base	md:text-lg rounded-3xl p-4 md:p-8  pb-8 md:pb-16">
        ...
        <p>
          ...
          conducted by the <strong>Census Bureau</strong> of United States.
        </p>
        <p>
          Height and body mass index is derived from the{" "}
          <strong>
            2017-2018 National Health and Nutrition Examination Survey (NHANES)
          </strong>{" "}
          conducted by the{" "}
          <strong>National Center for Health Statistics (NCHS)</strong>. The
          2017-2018 data was used instead of the most recent one due to
          suspension of survey operations in March 2020.
        </p>
      </div>
...
"
      ...
      <div className="bg-secondary shadow-xl space-y-4 text-base	md:text-lg rounded-3xl p-4 md:p-8  pb-8 md:pb-16">
        ...
        <p>
          By ticking the <strong>exclude married </strong>option you are
          filtering out the first two options from the sample data.{" "}
        </p>
      </div>
      {/* section 3 Race */}
      <H_Two
...
"
      ...
      <div className="bg-secondary shadow-xl space-y-4 text-base	md:text-lg rounded-3xl p-4 md:p-8  pb-8 md:pb-16">
        ...
        <p>
          ...
          searches, one for income and one for body measures, then it combines
          the two results (both opportunely filtered by age, marital status and
          race) into one single percentage value.
        </p>
        <p>
          The final percentage is not far from reality but it&apos;s not
          entirely accurate because it doesn&apos;t take into account the
          correlations between income and height or weight. For example, there
          have been studies showing that taller people tend to be paid slightly
          more. So, by processing the two searches independently, the calculator
          ...
          wouldn&apos;t expect the results to be way off, but keep it in mind
          and take the final number with a grain of salt.
        </p>
      </div>
    </div>
  );
